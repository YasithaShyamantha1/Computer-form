$(function() {
	'use strict';
	var ctx1 = document.getElementById('').getContext('2d');
	new Chart(ctx1, {
		type: 'bar',
		data: {
			labels: ['Colombo', 'Kandy', 'Mar', 'Apr', 'May', 'Jun'],
			datasets: [{
				label: '# of Votes',
				data: [12000, 39000, 20, 10, 25, 18],
	...
	new Chart(ctx2, {
		type: 'bar',
		data: {
			labels: ['Colombo', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
			datasets: [{
				label: '# of Votes',
	...
	new Chart(ctx3, {
		type: 'bar',
		data: {
			labels: ['aaaaa', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
			datasets: [{
				label: '# of Votes',
				data: [12, 39, 20, 10, 25, 18],
